#ifndef __WORLD_LEVEL_SELECT_CTRL_LAYER_H__
#define __WORLD_LEVEL_SELECT_CTRL_LAYER_H__
...
class WorldLevelSelectCtrlLayer : public UILayer
{
public:
  enum State {
    Inactive,
...
public:
  static WorldLevelSelectCtrlLayer* create(WorldLevelScene* scene);
...
#endif // __WORLD_LEVEL_SELECT_CTRL_LAYER_H__
